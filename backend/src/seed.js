...
const users = [
  ...
  { username: 'Alexy', role: 'worker' },
  { username: 'Augustin', role: 'worker' },
  { username: 'Pierre-Clément', role: 'worker' },
  { username: 'Valentin', role: 'worker' },
  { username: 'Maxence', role: 'worker' },
  { username: 'Naiki', role: 'worker' },
  { username: 'Benoit', role: 'worker' },
  { username: 'Burak', role: 'worker' },
  { username: 'Bertrand', role: 'worker' },
  { username: 'Olivier', role: 'worker' },
  { username: 'Edgard', role: 'worker' },
